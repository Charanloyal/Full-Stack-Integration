...
// Create a transporter. In development, we use an Ethereal SMTP mailer or log directly to console.
let transporter;
...
const createTransporter = async () => {
  ...
  try {
    // If SMTP environment variables are set and not placeholder, use them
    ...
    // Console log transporter fallback
    transporter = {
